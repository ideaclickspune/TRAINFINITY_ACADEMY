      ...
      >
        <Container className="flex items-center justify-between gap-4">
          ...
          <div className="hidden lg:flex items-center gap-2 shrink-0">
            ...
            <a
              href={`tel:${ACADEMY_INFO.phone.tel}`}
              className="inline-flex items-center justify-center gap-1.5 px-3.5 py-2 rounded-full bg-slate-100/90 hover:bg-slate-200 text-brand-navy border border-slate-200 text-xs font-bold transition-all shadow-2xs hover:border-brand-teal"
              title="Call Trainfinity Academy"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center justify-center gap-1.5 px-4 py-2 rounded-full bg-[#25D366] hover:bg-[#20bd5a] text-white text-xs font-bold shadow-xs active:scale-[0.98] transition-all group whitespace-nowrap"
          ...
          <div className="relative ml-auto w-full max-w-xs bg-white/95 backdrop-blur-2xl h-full shadow-2xl flex flex-col justify-between p-6 z-10 overflow-y-auto border-l border-white/40">
            ...
            <div className="pt-6 border-t border-slate-200 space-y-3">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-full inline-flex items-center justify-center gap-2 px-5 py-3 rounded-xl bg-[#25D366] text-white text-xs font-bold shadow-md hover:bg-[#20bd5a] transition-all"
              >
              ...
              <div className="text-xs text-slate-500 text-center pt-1">
                <p className="text-[10px]">{ACADEMY_INFO.address.city}, Maharashtra</p>
              </div>
            </div>
          </div>
        </div>
